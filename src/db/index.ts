...
import { mindmaps, mindmapNodes, mindmapEdges, mindmapChatHistory } from './schema';
...
export const db = drizzle(client, { schema: { mindmaps, mindmapNodes, mindmapEdges, mindmapChatHistory } });
