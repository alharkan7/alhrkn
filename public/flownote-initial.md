...
**Tips:**
- Click **+ Append Section** at the bottom to add new child nodes
...
**Right-click on empty canvas** to access:
- **New Note**: Add a node at cursor position
- **Auto Layout**: Automatically arrange all nodes in a tree structure
...
- **Resize** by dragging corner handles when selected
...
- **Color**: Change the node's color theme (red, orange, green, blue, purple, pink)
- **Toggle Branch**: Show or hide all descendant nodes
